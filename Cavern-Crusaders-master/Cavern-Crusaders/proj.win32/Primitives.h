...
namespace BathMat
{
	...
	public:
		...
		PrimitiveCricle(const cocos2d::Vec2 &a_StartPostion, const float &a_Radius, const float &a_Angle, const unsigned int &a_Segments, const bool &a_DrawLineToCenter);
	...
	{
	public:
		PrimitiveTriangle(const cocos2d::Vec2 &point1, const cocos2d::Vec2 &point2, const cocos2d::Vec2 &point3);
		PrimitiveTriangle();
